...
- (void)mouseUp:(NSEvent *)mouseEvent
{
	...
	if ( (urlAtMouse != nil)  &&  [urlAtMouse isEqualTo:clickedURL] ) {
        ...
        // 2011-01-07 (ADH): Commented out the 'if' part of the two lines below, leaving
        // just the 'open URL' part. Add Folder Icons doesn't use delegates for this and the
        // code as written generates a distracting (and basically incorrect) compiler warning.
